...
# Cargamos el dataset
dataset <- fread("./exp/FE777000b/inflation_adjusted_dataset.csv")
...
varlist <- c("ctrx_quarter_normalizado","cpayroll_trx","mcuentas_saldo","mpayroll_sobre_edad",   
             "mpasivos_margen","mrentabilidad_annual","mcaja_ahorro","mtarjeta_visa_consumo",    
             "mcomisiones_mantenimiento","mcuenta_corriente","mprestamos","cociente_mrentabilidad",   
             "mprestamos_personales","cliente_edad","mactivos_margen","mrentabilidad",            
             "mv_status01","cdescubierto_preacordado","Master_Fvencimiento","Master_fechaalta",         
             "mv_mpagominimo","numero_de_cliente","ccomisiones_otras","Visa_fechaalta",           
             "Visa_Fvencimiento","Visa_cconsumos","mv_status02","mv_Fvencimiento",          
             "Visa_mconsumospesos","cproductos",
             "foto_mes","clase_ternaria")

dataset <- dataset[,.SD,.SDcols = varlist]

#genero el archivo para Kaggle
#primero creo la carpeta donde va el experimento
dir.create( "./exp/" )
dir.create( "./exp/FE777006b" )

fwrite( dataset, #solo los campos para Kaggle
        file= "./exp/FE777006b/culled_dataset.csv",
        sep=  "," )