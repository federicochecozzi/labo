...
PARAM <- list()
PARAM$experimento  <- "DA777008balt"
...
PARAM$finalmodel$max_bin           <-     301
PARAM$finalmodel$max_depth         <-     -1
PARAM$finalmodel$learning_rate     <-      0.010802   #0.0142501265
PARAM$finalmodel$num_iterations    <-    578  #615
PARAM$finalmodel$num_leaves        <-   2763  #784
PARAM$finalmodel$min_data_in_leaf  <-   814  #5628
PARAM$finalmodel$feature_fraction  <-      0.5590244  #0.8382482539
PARAM$finalmodel$lambda_l1         <-      13.24962
PARAM$finalmodel$lambda_l2         <-      1.679275
