...
PARAM  <- list()
PARAM$experimento <- "TS777001c"

PARAM$exp_input  <- "FE777001c"

PARAM$future  <-  c( 202107 )  #donde vol a aplicar el  modelo, que NO tiene clase
PARAM$final_train  <-  c(  202012, 202101, 202102, 202103, 202104, 202105 )  #seis meses, donde voy a generar el modelo final, el que voy a entregar, notar que llega hasta 202105 el ultimo mes que tengo clase

PARAM$train$training   <-  c( 202010, 202011, 202012,  202101, 202102, 202103 )  #seis meses
PARAM$train$validation  <-  c( 202104 )
PARAM$train$testing <-  c( 202105  )  #El ultimo mes con clase
...
PARAM$train$semilla_sampling  <- 671017
PARAM$train$semilla_under     <- 273107
