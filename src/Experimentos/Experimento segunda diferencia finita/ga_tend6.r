...
PARAM <- list()
PARAM$experimento  <- "DA777003z"

PARAM$input$dataset       <- "./exp/FE777003z/dataset.csv.gz"
...
PARAM$finalmodel$learning_rate     <-      0.005003672
PARAM$finalmodel$num_iterations    <-    1114
PARAM$finalmodel$num_leaves        <-    480
PARAM$finalmodel$min_data_in_leaf  <-   969
PARAM$finalmodel$feature_fraction  <-      0.2710925
