...
PARAM <- list()
PARAM$experimento  <- "DA777002z"

PARAM$input$dataset       <- "./exp/FE777002z/dataset.csv.gz"
PARAM$input$training      <- c( 201904 )
PARAM$input$future        <- c( 201906 )

PARAM$semilla1  <- 200177
PARAM$semillas_modelo    <- 50

PARAM$finalmodel$max_bin           <-     31
PARAM$finalmodel$learning_rate     <-      0.005280163
PARAM$finalmodel$num_iterations    <-    1045
PARAM$finalmodel$num_leaves        <-    970
PARAM$finalmodel$min_data_in_leaf  <-   2415
PARAM$finalmodel$feature_fraction  <-      0.5657644
