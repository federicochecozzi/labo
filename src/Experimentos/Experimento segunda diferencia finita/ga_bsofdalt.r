...
PARAM <- list()
PARAM$experimento  <- "DA777002zalt"
...
PARAM$finalmodel$learning_rate     <-      0.005507789
PARAM$finalmodel$num_iterations    <-    1140
PARAM$finalmodel$num_leaves        <-    628
PARAM$finalmodel$min_data_in_leaf  <-   2502
PARAM$finalmodel$feature_fraction  <-      0.6771409
