...
PARAM$finalmodel$learning_rate     <-      0.00514559
PARAM$finalmodel$num_iterations    <-    1600
PARAM$finalmodel$num_leaves        <-    27
PARAM$finalmodel$min_data_in_leaf  <-   8
PARAM$finalmodel$feature_fraction  <-      0.9022375
