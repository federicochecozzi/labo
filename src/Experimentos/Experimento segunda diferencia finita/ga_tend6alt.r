...
PARAM <- list()
PARAM$experimento  <- "DA777003zalt"
...
PARAM$finalmodel$learning_rate     <-      0.005029847
PARAM$finalmodel$num_iterations    <-    1619
PARAM$finalmodel$num_leaves        <-    776
PARAM$finalmodel$min_data_in_leaf  <-   1717
PARAM$finalmodel$feature_fraction  <-      0.5175148
