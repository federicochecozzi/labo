...
PARAM  <- list()
PARAM$experimento  <- "DR777003d"
PARAM$dataset  <- "./exp/CA777001d/dataset.csv.gz"
...
periodos_analisis  <- c( 202109, 201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910)
