...
PARAM  <- list()
PARAM$experimento <- "TS777003d"

PARAM$exp_input  <- "FE777001d"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201905,201906,201907,201908,201909,201910,201911,201912, 202011, 202012, 202101, 202102, 202104)

PARAM$train$training     <- c( 201905,201906,201907,201908,201909,201910,201911,201912, 202011, 202012, 202101, 202102, 202104)
