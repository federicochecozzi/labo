...
dir.create( "./exp/HT777006/", showWarnings = FALSE )
setwd("./exp/HT777006/")   #Establezco el Working Directory DEL EXPERIMENTO

#defino los archivos donde guardo los resultados de la Bayesian Optimization
archivo_log  <- "HT777006.txt"
archivo_BO   <- "HT777006.RDATA"
