...
dir.create( "./exp/HT777008/", showWarnings = FALSE )
setwd("./exp/HT777008/")   #Establezco el Working Directory DEL EXPERIMENTO

#defino los archivos donde guardo los resultados de la Bayesian Optimization
archivo_log  <- "HT777008.txt"
archivo_BO   <- "HT777008.RDATA"
