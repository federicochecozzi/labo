...
setwd("C:\\Users\\tiama\\OneDrive\\Documentos\\DMEyF_2022")  #establezco la carpeta donde voy a trabajar
#cargo el dataset
...
modelo_original <- rpart(
  formula= "clase_ternaria ~ . -mcomisiones_mantenimiento -Visa_mpagado -numero_de_cliente",
  data= dtrain,
  model= TRUE,
  xval= 0,
  cp= -1,
...
dir.create( "./exp/" )
dir.create( "./exp/KA777004" )

fwrite( entrega, file = "./exp/KA777004/KA777004_002.csv", sep="," )

pdf(file = "./exp/KA777004/KA777004_002.pdf", width=28, height=4)
