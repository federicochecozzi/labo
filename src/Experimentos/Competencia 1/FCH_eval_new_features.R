...
modelo  <- rpart(formula=   "clase_ternaria ~ .",  #quiero predecir clase_ternaria a partir de el resto de las variables
                 ...
                 xval=      0,
                 cp=       -0.04,   #esto significa no limitar la complejidad de los splits
                 minsplit=  1338,     #minima cantidad de registros para que se haga el split
...
dir.create( "./exp/" )
dir.create( "./exp/KA777002" )

fwrite( dapply[ , list(numero_de_cliente, Predicted) ], #solo los campos para Kaggle
        file= "./exp/KA777002/KA777002_001.csv",
        sep=  "," )
