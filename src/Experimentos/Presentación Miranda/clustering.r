...
sampling_total <- 1.0
undersampling_continua <- 0.5*(dataset[ clase_ternaria != "CONTINUA",.N] / dataset[,.N])
...
#muestreo CONTINUA de manera de quedarme con tres clústeres de tamaños comparables 
