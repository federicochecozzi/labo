...
dataset  <- fread("./exp/FE777002/dataset_con_features.csv")   #donde entreno
...
dir.create( "./exp/HT777003/", showWarnings = FALSE )
setwd("./exp/HT777003/")   #Establezco el Working Directory DEL EXPERIMENTO

#defino los archivos donde guardo los resultados de la Bayesian Optimization
archivo_log  <- "HT777003.txt"
archivo_BO   <- "HT777003.RDATA"
