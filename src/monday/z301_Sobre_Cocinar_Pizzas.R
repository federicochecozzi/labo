...
## No se ve afectada por el desbalanceo
## - ¿Qué hay que cambiar en la función de ganancia para poder utilizarla? 
## Cambiar los coeficientes de ganancia para ajustar por proporción
...
## Nota: Modificar experimento_rpart para no muestrear y usar ganancia en vez de auc
